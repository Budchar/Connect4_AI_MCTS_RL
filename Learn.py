    ...
    for i in range(30):
        ...
        while not g.winner and g.cells > 0:
            ...
            if emcee == 0:
                ...
                # g.input(col)
                Time_Stone1 = level3.Agamotto(g, EyesOfAgamotto, Battle_Count)
                g.input(g.validate_input_col(Time_Stone1.VictoryNumber()))
                EyesOfAgamotto = Time_Stone1.EOA
                Battle_Count = Time_Stone1.BC
